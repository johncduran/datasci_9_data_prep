...
df = pd.read_csv('/home/john_duran/datasci_9_data_prep/code/model_dev/data/processed/drugs_num.csv')
len(df)
...
X = df.drop('stub_label_num', axis=1)  # Features (all columns except 'arrest')
y = df['stub_label_num']               # Target variable (arrest)

# Initialize the StandardScaler
scaler = StandardScaler()
scaler.fit(X) # Fit the scaler to the features
pickle.dump(scaler, open('/home/john_duran/datasci_9_data_prep/code/model_dev/models/scaler_drug.sav', 'wb')) # Save the scaler for later use
...
pickle.dump(X_train, open('/home/john_duran/datasci_9_data_prep/code/model_dev/models/X_train_drug.sav', 'wb'))
# Pkle X.columns for later use in explanation
pickle.dump(X.columns, open('/home/john_duran/datasci_9_data_prep/code/model_dev/models/X_columns_drug.sav', 'wb'))
...
exp.save_to_file('/home/john_duran/datasci_9_data_prep/code/model_dev/models/observation_1.html')

## save the model
pickle.dump(xgboost, open('/home/john_duran/datasci_9_data_prep/code/model_dev/models/xgboost_drug.sav', 'wb'))
...
# Import the clean random sample of 10k data
df = pd.read_csv('/home/john_duran/datasci_9_data_prep/code/model_dev/data/processed/suicide_num.csv')
len(df)
...
scaler = StandardScaler()
scaler.fit(X) # Fit the scaler to the features
pickle.dump(scaler, open('/home/john_duran/datasci_9_data_prep/code/model_dev/models/suicide_deaths.sav', 'wb')) # Save the scaler for later use
...
# Pkle the X_train for later use in explanation
pickle.dump(X_train, open('/home/john_duran/datasci_9_data_prep/code/model_dev/models/X_train_suicide.sav', 'wb'))
# Pkle X.columns for later use in explanation
pickle.dump(X.columns, open('/home/john_duran/datasci_9_data_prep/code/model_dev/models/X_columns_suicide.sav', 'wb'))
...
## save the model
pickle.dump(xgboost, open('/home/john_duran/datasci_9_data_prep/code/model_dev/models/xgboost_suicide.sav', 'wb'))
